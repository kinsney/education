"""
Misago settings for kinsney project.
...
SECRET_KEY = '@9k)&wps!!_&*$fm4p5=yai0kq%30=%$d3zd*icl2&)q-@x)j&'
...
ROOT_URLCONF = 'kinsney.urls'
WSGI_APPLICATION = 'kinsney.wsgi.application'
