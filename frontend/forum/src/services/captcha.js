    ...
    componentDidMount() 
    {
        grecaptcha.render('recaptcha', 
        {
            ...
            'callback': (response) => {
                ...
                this.props.binding({target: {value: response } });
            }
        });
    }
    ...
    load() 
    {
        ...
        return new Promise(function(resolve) 
        {
            var wait = function() 
            {
                ...
                {
                    window.setTimeout(function() {wait(); }, 200); 
                } 
                else resolve();
            };
            wait();
...
export class Captcha 
{
    ...
    load() {return this._captcha.load(); }

    validator() {return this._captcha.validator(); }

    component(kwargs) {return this._captcha.component(kwargs); }
}
