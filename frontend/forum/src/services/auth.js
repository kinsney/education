...
export class Auth 
{
    ...
    syncSession() 
    {
        ...
        {
            this._local.set('auth', {isAuthenticated:true, username:state.user.username });
        }
        else this._local.set('auth', {isAuthenticated: false });
    }
    ...
    watchState() 
    {
        this._local.watch('auth', (newState)=>{
            ...
            {
                this._store.dispatch(signIn({username: newState.username }));
            } 
            else this._store.dispatch(signOut());
        });
        this._modal.hide();
    }
    ...
    signIn(user) 
    {
        ...
        this._local.set('auth', {isAuthenticated: true, username: user.username });
        this._modal.hide();
    }
    ...
    signOut() 
    {
        ...
        this._local.set('auth', {isAuthenticated: false });
        this._modal.hide();
    }
